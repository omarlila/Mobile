...
class APrivateOrganizationAIChatbotForSpecificDomainsSupabaseUser
    extends BaseAuthUser {
  APrivateOrganizationAIChatbotForSpecificDomainsSupabaseUser(this.user);
  User? user;
...
Stream<BaseAuthUser>
    aPrivateOrganizationAIChatbotForSpecificDomainsSupabaseUserStream() {
  ...
  return (!loggedIn
      ...
      .map<BaseAuthUser>(
    (authState) {
      currentUser = APrivateOrganizationAIChatbotForSpecificDomainsSupabaseUser(
